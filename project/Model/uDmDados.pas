...
type
  TdmDados = class(TDataModule)
    ...
    dsoImprimevendas: TDataSource;
    DataSetProviderImprimevendas: TDataSetProvider;
    ClientDataSetImprimevendas: TClientDataSet;
    ...
    qryImprimeItemVendas: TSQLQuery;
    dsoImprimeItemVendas: TDataSource;
    DataSetProviderImprimeItemVendas: TDataSetProvider;
    ClientDataSetImprimeItemVendas: TClientDataSet;
    qryImprimeItemVendasID_ITEM_VENDA: TIntegerField;
    qryImprimeItemVendasID_VENDA: TIntegerField;
    qryImprimeItemVendasQT_ITEM: TIntegerField;
    qryImprimeItemVendasVL_UNITARIO: TFMTBCDField;
    qryImprimeItemVendasVL_TOTAL_ITEM: TFMTBCDField;
    qryImprimeItemVendasID_PRODUTO: TIntegerField;
    qryImprimeItemVendasDESCRICAO: TWideStringField;
    ClientDataSetImprimeItemVendasID_ITEM_VENDA: TIntegerField;
    ClientDataSetImprimeItemVendasID_VENDA: TIntegerField;
    ClientDataSetImprimeItemVendasQT_ITEM: TIntegerField;
    ClientDataSetImprimeItemVendasVL_UNITARIO: TFMTBCDField;
    ClientDataSetImprimeItemVendasVL_TOTAL_ITEM: TFMTBCDField;
    ClientDataSetImprimeItemVendasID_PRODUTO: TIntegerField;
    ClientDataSetImprimeItemVendasDESCRICAO: TWideStringField;
