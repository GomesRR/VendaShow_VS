object frmVendedores: TfrmVendedores
  ...
  object pnlFiltro: TPanel
    ...
    object btnCadastrarVendedor: TStyledGraphicButton
      AlignWithMargins = True
      Left = 777
      Top = 12
      Width = 191
      ...
      Font.Name = 'Tahoma'
      Font.Style = []
      OnClick = btnCadastrarVendedorClick
      ParentFont = False
      StyleElements = [seFont, seBorder]
      Caption = '(F5) &Cadastrar Vendedor'
      Flat = True
      StyleRadius = 15
      StyleClass = 'Calypso'
    ...
    object pnlEdtProduto: TPanel
      ...
      object edtNomeVendedor: TEdit
        ...
        ParentFont = False
        TabOrder = 0
        TextHint = 'DIGITE O NOME DO VENDEDOR...'
        OnKeyDown = FormKeyDown
      end
    end
  end
  object Panel6: TPanel
    ...
    object dbgVendedores: TDBGrid
      ...
      TitleFont.Style = []
      OnDrawColumnCell = dbgVendedoresDrawColumnCell
      OnDblClick = dbgVendedoresDblClick
      OnKeyDown = FormKeyDown
      Columns = <
        item
          Alignment = taCenter
